...
public class ModWidgets
{
    ...
    public static final DeferredHolder<Widget, Widget> WINDOW_CRAFTING = register(GROUP_WINDOWS_ID,
        WINDOW_CRAFTING_ID,
    ...
    public static final DeferredHolder<Widget, Widget> WINDOW_SMITHING_TABLE = register(GROUP_WINDOWS_ID,
